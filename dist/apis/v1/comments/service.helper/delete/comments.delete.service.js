...
exports.CommentsDeleteService = void 0;
...
let CommentsDeleteService = class CommentsDeleteService {
    constructor(commentEntity, tasksService) {
        this.commentEntity = commentEntity;
        this.tasksService = tasksService;
    }
    async deleteById({ _commentId }, user) {
        const comment = await this.commentEntity.findById(_commentId);
        if (comment === null) {
            throw new common_1.HttpException(`Not Found comment`, common_1.HttpStatus.NOT_FOUND);
        }
        if (comment._userId.toString() !== user._id) {
            throw new common_1.HttpException(`Can't delete comment`, common_1.HttpStatus.FORBIDDEN);
        }
        this.tasksService.removeComment(comment._taskId, _commentId);
        return await this.commentEntity.findByIdAndDelete(_commentId);
    }
    async deleteByTaskId(_taskId) {
...
CommentsDeleteService = __decorate([
...
exports.CommentsDeleteService = CommentsDeleteService;
//# sourceMappingURL=comments.delete.service.js.map