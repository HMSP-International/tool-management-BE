...
exports.SpacesPutService = void 0;
const common_1 = require("@nestjs/common");
const mongoose_1 = require("@nestjs/mongoose");
const mongoose_2 = require("mongoose");
const space_model_1 = require("../../classes/space.model");
let SpacesPutService = class SpacesPutService {
    constructor(spaceEntity) {
        this.spaceEntity = spaceEntity;
    }
    async changeName(changeNameSpaceInput) {
        const { _id } = changeNameSpaceInput, rest = __rest(changeNameSpaceInput, ["_id"]);
...
SpacesPutService = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, mongoose_1.InjectModel)(space_model_1.SpaceModel.name)),
    __metadata("design:paramtypes", [mongoose_2.Model])
], SpacesPutService);
exports.SpacesPutService = SpacesPutService;
//# sourceMappingURL=spaces.put.service.js.map