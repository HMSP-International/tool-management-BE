...
exports.TasksPutModule = void 0;
const common_1 = require("@nestjs/common");
const mongoose_1 = require("@nestjs/mongoose");
const task_model_1 = require("../../classes/task.model");
const tasks_put_service_1 = require("./tasks.put.service");
...
let TasksPutModule = class TasksPutModule {
};
TasksPutModule = __decorate([
    (0, common_1.Module)({
        imports: [
        ...
        providers: [tasks_put_service_1.TasksPutService],
        exports: [tasks_put_service_1.TasksPutService],
    })
], TasksPutModule);
exports.TasksPutModule = TasksPutModule;
//# sourceMappingURL=tasks.put.module.js.map